...
//Audio
var music = new Audio("../sounds/charselect.mp3");
music.play();
var winner = new Audio("../sounds/VICTORY.wav");
var intro = new Audio("../sounds/CHOOSEYOURFIGHTER.wav");
intro.play;
var lose = new Audio("../sounds/NOCONTEST");
